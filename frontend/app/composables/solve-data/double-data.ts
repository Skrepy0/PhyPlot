...
export const solve = async (
  ...
  res.value = {
    k: format(k, significantDigits),
    m: format(m, significantDigits),
    yStdErr: format(yStdErr, significantDigits),
    kStdErr: format(kStdErr, significantDigits),
    mStdErr: format(mStdErr, significantDigits),
    corr: format(await getCorr(points), significantDigits),
  }
}
